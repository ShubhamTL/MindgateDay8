...
public class EmployeeDAO implements EmployeeDAOInterface {
	...
	private static final String SINGLE_EMPLOYEE = "select* From employee_details where employee_id=?";
	...
	public boolean addNewEmployee(Employee employee) {
		...
		System.out.println("Inserting new data in database");
	...
	public Employee getEmployeeByEmployeeId(int employeeId) {
		...
		Employee employee = jdbcTemplate.queryForObject(SINGLE_EMPLOYEE, args, new EmployeeRowMapper());
		return employee;
	}
